...
import img_mountains from "./assets/img_mountains.jpg";
import img_nature from "./assets/img_nature.jpg";
import img_snow from "./assets/img_snow.jpg";
...
function getLargePicture(id) {
  ...
  if(Number(id) === 0){
    img.setAttribute('src',`${img_lights}`);
